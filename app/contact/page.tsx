    ...
    <form onSubmit={handleSubmit} noValidate className="space-y-5">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
        <div>
          ...
          <input
            ...
            className={`${inputClass} ${errors.name ? "border-sky-500/60 focus:border-sky-500/60 focus:ring-sky-500/20" : ""}`}
            autoComplete="name"
          />
          {errors.name && (
            <p className="mt-1.5 text-xs text-sky-400 flex items-center gap-1">
              <AlertCircle size={12} />
              {errors.name}
            </p>
          )}
        ...
        <div>
          ...
          <input
            ...
            className={`${inputClass} ${errors.email ? "border-sky-500/60 focus:border-sky-500/60 focus:ring-sky-500/20" : ""}`}
            autoComplete="email"
          />
          {errors.email && (
            <p className="mt-1.5 text-xs text-sky-400 flex items-center gap-1">
      ...
      <div>
        ...
        <div className="relative">
          <select
            ...
            onChange={handleChange}
            className={`${inputClass} appearance-none pr-10 ${errors.subject ? "border-sky-500/60 focus:border-sky-500/60 focus:ring-sky-500/20" : ""}`}
          >
      ...
      <div>
        ...
        <textarea
          ...
          className={`${inputClass} resize-none ${errors.message ? "border-sky-500/60 focus:border-sky-500/60 focus:ring-sky-500/20" : ""}`}
        />
      ...
      {formState === "error" && (
        <motion.div
          ...
          className="flex items-center gap-3 p-4 rounded-xl bg-sky-500/10 border border-sky-500/20 text-sky-400 text-sm"
        >
...
function ContactInfoBlock() {
  ...
  return (
    <div className="flex flex-col gap-8 h-full">
      <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-green-500/10 border border-green-500/25 w-fit">
