    ...
    return (
      ...
      >
        <motion.div
          ...
          className="w-20 h-20 rounded-full bg-orange-500/10 border border-orange-500/30 flex items-center justify-center mb-6"
        >
    ...
    <form onSubmit={handleSubmit} noValidate className="space-y-5">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
        <div>
          ...
          <input
            ...
            className={`${inputClass} ${errors.name ? "border-pink-500/60 focus:border-pink-500/60 focus:ring-pink-500/20" : ""}`}
            autoComplete="name"
          />
          {errors.name && (
            <p className="mt-1.5 text-xs text-pink-400 flex items-center gap-1">
              <AlertCircle size={12} />
              {errors.name}
            </p>
          )}
        ...
        <div>
          ...
          <input
            ...
            className={`${inputClass} ${errors.email ? "border-pink-500/60 focus:border-pink-500/60 focus:ring-pink-500/20" : ""}`}
            autoComplete="email"
          />
          {errors.email && (
            <p className="mt-1.5 text-xs text-pink-400 flex items-center gap-1">
      ...
      <div>
        ...
        <div className="relative">
          <select
            ...
            onChange={handleChange}
            className={`${inputClass} appearance-none pr-10 ${errors.subject ? "border-pink-500/60 focus:border-pink-500/60 focus:ring-pink-500/20" : ""}`}
          >
      ...
      <div>
        ...
        <textarea
          ...
          className={`${inputClass} resize-none ${errors.message ? "border-pink-500/60 focus:border-pink-500/60 focus:ring-pink-500/20" : ""}`}
        />
      ...
      {formState === "error" && (
        <motion.div
          ...
          className="flex items-center gap-3 p-4 rounded-xl bg-pink-500/10 border border-pink-500/20 text-pink-400 text-sm"
        >
...
function ContactInfoBlock() {
  ...
  return (
    <div className="flex flex-col gap-8 h-full">
      <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-orange-500/10 border border-orange-500/25 w-fit">
